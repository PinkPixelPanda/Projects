...
# Ask user which file to use for calculating grades
file_choice = input("Which file would you like to use for calculating grades? (grades_0.csv or grades_50.csv): ").strip()

# Validate user input for file choice
while file_choice not in ["grades_0.csv", "grades_50.csv"]:
    print("Invalid file choice. Please enter either 'grades_0.csv' or 'grades_50.csv'.")
    file_choice = input("Which file would you like to use for calculating grades? (grades_0.csv or grades_50.csv): ").strip()
...
try:
    ...
    print(f"Grades from {file_choice}:")
    print(df)
    print()
    ...
    print(f"Error reading or processing {file_choice}: {e}")
    exit()
